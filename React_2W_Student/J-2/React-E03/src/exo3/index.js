...
import {render} from '../exo2/index';

var obj ={lang: 'ES2015', method: 'innerHTML'}

function helloWorld(param){
    return `<div id="hello-world">
            <h1>Ce HTML a été généré par ${param.lang}</h1>
            <h2>Et affiché avec ${param.method}</h2>
          </div>`
}

document.addEventListener('DOMContentLoaded', render(helloWorld(obj)));
